...
public class Button {
	...
	public Button(String path) {
		try {
			//Each button has its own package and are named as 0 for unmoused over and 1 for moused over
	...
	/**
	 * draws the button at a given coordinate
	...
	public void draw(Graphics g, int x, int y){
		//gets the coordinates of where it's drawn for the update method
		this.x = x;
		this.y = y;
	...
	/**
	 * A method that checks whether the mouse is over the button and if it's clicked it returns true for the update loop to handle the results
